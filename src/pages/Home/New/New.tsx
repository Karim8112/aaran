...
const GSAPScrollSequence: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      if (rows.length === 3) {
        gsap.set([rows[0], rows[2]], { xPercent: 50 });
        ...
        ScrollTrigger.create({
          ...
          scrub: true,
          onUpdate: (self) => {
            const rightOffset = (1 - self.progress) * 50;
            const leftOffset = (1 - self.progress) * -50;
      ...
      <section className="services w-full h-screen flex justify-center items-center relative overflow-hidden z-[5]">
        <div className="services-container w-full flex flex-col justify-center items-center gap-[1.5vh] will-change-transform">
          ...
          >
            <svg viewBox="0 0 1000 120" className="w-full h-auto max-h-[18vh]">
              <text
                ...
                text-anchor="middle"
                fill="currentColor"
                className="font-light text-[110px] tracking-tight"
              >
                What We Do
              </text>
            </svg>
          ...
          <div
            ...
            className="services-header row-middle w-full max-w-[1300px] flex justify-center items-center will-change-transform z-[10] text-[#d1b797]"
          >
            <svg viewBox="0 0 1000 120" className="w-full h-auto max-h-[18vh]">
              <text
                x="50%"
                ...
                text-anchor="middle"
                fill="currentColor"
                className="font-medium text-[110px] tracking-wide"
              >
                What We Do
              </text>
            </svg>

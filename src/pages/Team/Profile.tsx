    ...
    <div className="min-h-screen bg-[#f7f7f7] text-[#111111] font-sans selection:bg-[#111] selection:text-white px-6 md:px-16 lg:px-24 py-10 max-w-360 mx-auto antialiased">
      ...
      >
        ...
        >
          ...
          <a href="#linkedin" className="hover:text-black transition-colors">
            LINKEDIN
          </a>
          ...
          <div className="flex flex-col gap-0.5">
            ...
            <div className="flex gap-2">
              ...
              <span>/</span>
              <a href="#behance" className="hover:text-black transition-colors">
                BEHANCE
              </a>
            </div>
          </div>
          ...
          >
            ...
            <div className="flex flex-col gap-4">
              <p className="text-sm sm:text-base text-black/80 font-normal leading-relaxed max-w-lg">
                ...
                possibilities—fostering meaningful innovation while guiding and
                empowering my team.
              </p>
          ...
          >
            ...
            <motion.div variants={fadeInUp} className="flex flex-col gap-3">
              ...
              <ul className="list-disc list-inside flex flex-col gap-1.5 text-xs sm:text-sm text-black/75 leading-relaxed pl-1">
                <li>
                  Participated in initial project estimations and contributed to
                  the definition of designed processes.
                </li>
                <li>
                  Collaborated with stakeholders and team members to establish
                  project scope and requirements.
                </li>
                <li>
                  Assisted in creating project timelines and resource allocation
                  plans.
                </li>
                <li>
                  Facilitated workshops to gather requirements and align project
                  goals.
                </li>
              </ul>
            </motion.div>
            ...
            <motion.div variants={fadeInUp} className="flex flex-col gap-3">
              ...
              <ul className="list-disc list-inside flex flex-col gap-1.5 text-xs sm:text-sm text-black/75 leading-relaxed pl-1">
                <li>
                  Oversaw the end-to-end product development process, ensuring
                ...
                <li>
                  ...
                  enhance user experience and drive continued product success.
                </li>
              </ul>
            </motion.div>
            ...
            <motion.div variants={fadeInUp} className="flex flex-col gap-3">
              ...
              <ul className="list-disc list-inside flex flex-col gap-1.5 text-xs sm:text-sm text-black/75 leading-relaxed pl-1">
                <li>
                  ...
                  managers, business analysts, developers, QA analysts, content
                  writers, and product owners.
                </li>
              </ul>
            </motion.div>
          </motion.div>
